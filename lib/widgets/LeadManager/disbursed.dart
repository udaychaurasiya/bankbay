        ...
        children: [
              ...
              children: [
                InkWell(
                  onTap: () {
                    showMenu(
                      ...
                      controller.disbursedLeadsNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                    });
                  },
                  child: Row(
                    children: [
                ...
                InkWell(
                  onTap: () {
                    showMenu(
                      context: context,
                      position: RelativeRect.fromSize(Rect.fromCircle(center:  Offset(controller.filterTypeSelected.value=="All Source"?80.r:71.r, 165), radius: 5), const Size(150, 300)),
                      items: <PopupMenuEntry<String>>[
                        PopupMenuItem(
                          value: 'All Source'.tr,
                          child: SizedBox(
          ...
          Container(
            ...
            child: ListView(
              ...
              children: [
                ...
                // SizedBox(width: 15.r),
                buildRadioButtonEMP("Disburse Validation", "Disburse Validation"),
                SizedBox(width: 15.r),
                      ...
                      children: [
                        WeeklyDatePicker(
                          ...
                          changeDay: (value)async{
                            ...
                            await controller.disbursedLeadsNetworkApi(DateFormat('yyy-MM-dd').format(value).toString(),DateFormat('yyy-MM').format(value),partnerController.loanTypeDecode(controller.selectLoanType.value),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                            },
                        ...
                        InkWell(
                          onTap: ()async{
                            bool status = await controller.disbursedLeadsNetworkApi("", "",partnerController.loanTypeDecode(controller.selectLoanType.value),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                            if(status==true){
          ...
          Expanded(
            child: SingleChildScrollView(
              controller: controller.disbursedLeadController,
              child: Container(
                  ...
                  children: [
                    Obx(() {
                      return ListView.builder(
                          itemCount: controller.disbursed_data_model.value.data.disbursedLeade.length,
                          shrinkWrap: true,
                          physics: const NeverScrollableScrollPhysics(),
                          padding: EdgeInsets.only(bottom: 5.r),
                          itemBuilder: (context, index){
                            var data = controller.disbursed_data_model.value.data.disbursedLeade[index];
                            bool isLastItem = index == controller.disbursed_data_model.value.data.disbursedLeade.length - 1;
                            return CustomLeadsDetails(
                              ...
                              index: isLastItem,
                              detailsTap: ()async{
                                await controller.disbursedLeadsNetworkApi("", "",partnerController.loanTypeDecode(controller.selectLoanType.value),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                                bool checkStatus = await controller.disbursedLeadsNetworkApi("", "",partnerController.loanTypeDecode(controller.selectLoanType.value),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                                if(checkStatus==true){
                                  if(controller.disbursed_data_model.value.data.disbursedLeade[index].leadLockStatus=="false") {
                                    bool status = await permissionController.lockUnlockLeadNetworkApi(controller.disbursed_data_model.value.data.disbursedLeade[index].leadId, "true");
                                    if(status==true) {
                                      Get.to(()=> CustomerDetails(leadId: "${data.id??""}",customerId: data.custId??"",value: "leadDetails",apiLeadId: data.leadId, pageName: "disbursedLead",));
                                      controller.disbursedLeadsNetworkApi("", "",partnerController.loanTypeDecode(controller.selectLoanType.value),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                                    }
                                  }else{
                                    BaseController().errorSnack("Already details View on ${controller.disbursed_data_model.value.data.disbursedLeade[index].lockedBy.toString()}");
                                    controller.disbursedLeadsNetworkApi("", "",partnerController.loanTypeDecode(controller.selectLoanType.value),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                                  }
                                }
                              },
                                  ...
                                  if(value == "Transfer Lead"){
                                    ...
                                    if(checkStatus==true){
                                      if( controller.disbursed_data_model.value.data.disbursedLeade[index].leadLockStatus=="false") {
                                        bool status = await permissionController.lockUnlockLeadNetworkApi( controller.disbursed_data_model.value.data.disbursedLeade[index].leadId, "true");
                                        if(status==true) {
                                          Get.to(()=> CustomerDetails(leadId: "${data.id??""}",customerId: data.custId??"",value: "leadDetails",apiLeadId: data.leadId, pageName: "disbursedLead",leadTransferName: "transferLead",));
                                          controller.disbursedLeadsNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","", partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                                        }
                                      }else{
                                        BaseController().errorSnack("Already details View on ${ controller.disbursed_data_model.value.data.disbursedLeade[index].lockedBy.toString()}");
                    ...
                    Obx(() => controller.disbursed_data_model.value.message.toString()=="Data Not Found."?
                        Container(
                      ...
                      children: [
                        ...
                        CustomButton(
                          ...
                          onTap: () async {
                            ...
                            controller.disbursedLeadsNetworkApi("", "",partnerController.loanTypeDecode(controller.selectLoanType.value), controller.customerPan.text, controller.customerPhone.text, controller.leadStartDate.text, "", controller.leadEndDate.text,partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                            controller.loanType.value="All Loan";
                            controller.customerPan.clear();
                            controller.customerPhone.clear();
                            controller.leadStartDate.clear();
