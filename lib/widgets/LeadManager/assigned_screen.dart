          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                ...
                SizedBox(width: selectedValidation.value=="All Status"?25.r:15.r),
                InkWell(
                  onTap: () {
                    showMenu(
                      context: context,
                      ...
                      return ListView.builder(
                            ...
                            itemBuilder: (context, index){
                              ...
                              return CustomLeadsDetails(
                                ...
                                index: isLastItem,
                                detailsTap: ()async{
                                  bool checkStatus = await controller.allLeadsDataNetworkApi("","","",partnerController.loanTypeDecode(selectLoanType.value.toString()),"","","","assigned",controller.filterTypeSelected.value,partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                                  if(checkStatus==true){
                                  if(controller.allLeadsDataModel.value.data.newLeade[index].leadLockStatus=="false") {
                                    ...
                                    if(status==true) {
                                      Get.to(()=> CustomerDetails(leadId: "${data.id??""}",customerId: data.custId??"",value: "leadDetails",apiLeadId: data.leadId, pageName: "assigned",));
                                      controller.allLeadsDataNetworkApi("","","",partnerController.loanTypeDecode(selectLoanType.value.toString()),"","","","assigned",controller.filterTypeSelected.value,partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                                    }
                                  }else{
                                    ...
                                    if(value == "Transfer Lead"){
                                      ...
                                      if(checkStatus==true){
                                        if(controller.allLeadsDataModel.value.data.newLeade[index].leadLockStatus=="false") {
                                          bool status = await permissionController.lockUnlockLeadNetworkApi(controller.allLeadsDataModel.value.data.newLeade[index].leadId, "true");
                                          if(status==true) {
                                            Get.to(()=> CustomerDetails(leadId: "${data.id??""}",customerId: data.custId??"",value: "leadDetails",apiLeadId: data.leadId, pageName: "assigned",leadTransferName: "transferLead",));
                                            controller.unassignedNetworkApi("","","","","","","","");
                                          }
                                        }else{
                                          BaseController().errorSnack("Already details View on ${controller.allLeadsDataModel.value.data.newLeade[index].lockedBy.toString()}");
                                          controller.allLeadsDataNetworkApi("","","",partnerController.loanTypeDecode(selectLoanType.value.toString()),"","","","assigned",controller.filterTypeSelected.value,partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                      ...
                      children: [
                        ...
                        CustomButton(
                          ...
                          onTap: () async {
                            ...
                            controller.allLeadsDataNetworkApi("","","",controller.customerPan.text, controller.customerPhone.text, controller.leadStartDate.text, controller.leadEndDate.text,controller.leadsPageName.value,controller.filterTypeSelected.value,partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                            controller.loanType.value="All Loan";
                            controller.customerPan.clear();
                            controller.customerPhone.clear();
                            controller.leadStartDate.clear();
