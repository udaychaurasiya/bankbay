...
class IncentiveScreen extends StatefulWidget {
  ...
  @override
  State<IncentiveScreen> createState() => _IncentiveState();
}

class _IncentiveState extends State<IncentiveScreen> {
  ...
  @override
  void initState() {
    controller.incentiveDataNext = 10;
    controller.incentiveDataNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
    super.initState();
  }
          ...
          Container(
            ...
            child: ListView(
              ...
              children: [
                ...
                // SizedBox(width: 15.r),
                buildRadioButtonEMP("Incentive Validation", "Incentive Validation"),
                SizedBox(width: 15.r),
                ...
                SizedBox(width: 15.r),
                buildRadioButtonEMP("Inc Approval", "Inc Approval"),
                SizedBox(width: 15.r),
                buildRadioButtonEMP("Inc Paid", "Inc Paid"),
              ],
            ),
          ),
                      ...
                      children: [
                        WeeklyDatePicker(
                          ...
                          changeDay: (value)async{
                            ...
                            await controller.incentiveDataNetworkApi(DateFormat('yyy-MM-dd').format(value).toString(),DateFormat('yyy-MM').format(value),partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                          },
                        ...
                        InkWell(
                          onTap: ()async{
                            bool status = await controller.incentiveDataNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                            if(status==true){
                ...
                child: Column(
                  ...
                  children: [
                    GetBuilder<LoginController>(builder: (controller) {
                      return controller.incentive_loader.value?
                        ListView.builder(
                          itemCount: controller.incentive_model.value.data.disbursedLeade.length,
                          shrinkWrap: true,
                          physics: const NeverScrollableScrollPhysics(),
                          padding: EdgeInsets.only(bottom: 5.r),
                          itemBuilder: (context, index){
                            var data = controller.incentive_model.value.data.disbursedLeade[index];
                            bool isLastItem = index == controller.incentive_model.value.data.disbursedLeade.length - 1;
                            return CustomLeadsDetails(
                              ...
                              detailsTap: ()async{
                                bool checkStatus = await controller.incentiveDataNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                                if(checkStatus==true){
                                  if(controller.incentive_model.value.data.disbursedLeade[index].leadLockStatus=="false") {
                                    bool status = await permissionController.lockUnlockLeadNetworkApi(controller.incentive_model.value.data.disbursedLeade[index].leadId, "true");
                                    if(status==true) {
                                      Get.to(()=> CustomerDetails(leadId: "${data.id??""}",customerId: data.custId??"",value: "leadDetails",apiLeadId: data.leadId, pageName: "incentiveLead"));
                                      controller.incentiveDataNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                                    }
                                  }else{
                                    BaseController().errorSnack("Already details View on ${controller.incentive_model.value.data.disbursedLeade[index].lockedBy.toString()}");
                                    controller.incentiveDataNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                                  }
                                }
                              },
                              ...
                              child: Obx(()=> PopupMenuButton(
                                ...
                                onSelected: (value) async {
                                  ...
                                  if(value == "Transfer Lead"){
                                    bool checkStatus = await controller.incentiveDataNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                                    if(checkStatus==true){
                                      if(controller.sanctioned_leads_model.value.data.sanctionedLeade[index].leadLockStatus=="false") {
                                        bool status = await permissionController.lockUnlockLeadNetworkApi(controller.sanctioned_leads_model.value.data.sanctionedLeade[index].leadId, "true");
                                        if(status==true) {
                                          Get.to(()=> CustomerDetails(leadId: "${data.id??""}",customerId: data.custId??"",value: "leadDetails",apiLeadId: data.leadId, pageName: "incentiveLead", leadTransferName: "transferLead",));
                                          controller.incentiveDataNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                                        }
                                      }else{
                                        BaseController().errorSnack("Already details View on ${controller.sanctioned_leads_model.value.data.sanctionedLeade[index].lockedBy.toString()}");
                                        controller.incentiveDataNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                                      }
                                    }
                                  }else{
                    ...
                    Obx(() => controller.incentive_model.value.message.toString()=="Data Not Found."?
                      Container(
    ...
    return Obx(() => Row(
      children: [
        SizedBox(
          ...
          child: Radio(
            value: value,
            groupValue: controller.incentiveRadio.value,
            onChanged: (selectedValue) {
              controller.leadsPageName.value = selectedValue??"";
              controller.incentiveRadio.value = selectedValue.toString();
              if(selectedValue=="Inc Due"){
                controller.incentiveDataNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
              }else if(selectedValue=="Inc Approval"){
                controller.incentiveDataNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
              }else if(selectedValue=="Inc Paid"){
                controller.incentiveDataNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
              }else {
                controller.incentiveDataNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
              }
                      ...
                      children: [
                        ...
                        CustomButton(
                          ...
                          onTap: () async {
                            ...
                            // ("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","",partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                            // controller.incentiveDataNetworkApi("","", controller.customerPan.text,controller.loanType.value, controller.customerPhone.text, controller.leadStartDate.text, controller.leadEndDate.text,controller.leadsPageName.value,controller.filterTypeSelected.value);
                            controller.loanType.value="All Loan";
                            controller.customerPan.clear();
                            controller.customerPhone.clear();
                            controller.leadStartDate.clear();
