...
class LeadLoanForm extends StatefulWidget {
  const LeadLoanForm({super.key});

  @override
  State<LeadLoanForm> createState() => _LeadLoanFormState();
}

class _LeadLoanFormState extends State<LeadLoanForm> {
  LoginController controller = Get.find<LoginController>();
  GlobalKey<FormState> formKeyAddLead = GlobalKey<FormState>(debugLabel: "_formKeyAddLead");
        ...
        child: Column(
          children: [
            ...
            UnderLineTextField(
              ...
              hint: "Full Name".tr,
              label: true,
              controller: controller.leadName,
              onTap: () {},
              validator: (value) {
            ...
            UnderLineTextField(
              ...
              onTap: () async {
                ...
                if (pickedDate != null) {
                  ...
                  print(formattedDate);
                  controller.leadDob.text = formattedDate;
                } else {}
              },
              validator: (value) {
                if (value == null || value.isEmpty) {
            ...
            CustomUnderlineDropdownField(
              ...
              value:
              controller.maritalStatus.value, // Set the default value here
              onChanged: (String? newValue) {
                controller.maritalStatus.value =
                    newValue ?? "Select Marital Status";
              },
              validator: (value) {
                if (value == null || value.isEmpty) {
            ...
            UnderLineTextField(
              ...
              hint: "Email ID".tr,
              label: true,
              controller: controller.leadEmail,
            ...
            UnderLineTextField(
              ...
              label: true,
              controller: controller.leadPanCard,
              type: TextInputType.text,
              inputFormatters: [
            ...
            UnderLineTextField(
              ...
              controller: controller.leadNumber,
              onTap: () {},
              validator: (value) {
                if (value == null || value.isEmpty) {
            ...
            Row(
              ...
              children: [
                ...
                CustomButton(
                  ...
                  width: Get.width - 240,
                  onTap: () async {
                    if (formKeyAddLead.currentState != null && formKeyAddLead.currentState!.validate()) {
                      screenValue.value = 3;
                    }
                  },
                ),
