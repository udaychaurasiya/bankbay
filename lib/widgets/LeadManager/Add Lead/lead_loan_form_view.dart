...
class LeadLoanFormView extends StatelessWidget {
  const LeadLoanFormView({super.key});
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "So ${controller.leadName.text}, House No 842, Samachar \nApartment, Near Shiv Mandir \nDelhi",
          ...
          Row(
            ...
            children: [
              ...
              CustomButton(
                ...
                width: Get.width - 240,
                onTap: () async {
                  bool status = await controller.leadLoginNetworkApi();
                  if (status == true) {
                    screenValue.value = 4;
                  }
                },
