...
class SanctionScreen extends StatefulWidget {
  ...
  @override
  State<SanctionScreen> createState() => _SanctionScreen();
}

class _SanctionScreen extends State<SanctionScreen> {
                ...
                InkWell(
                  onTap: () {
                    showMenu(
                      ...
                      controller.sanctionedLeadsNetworkApi("","",partnerController.loanTypeDecode(value.toString()),"","","","","", partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                    });
                  },
                  child: Row(
                    children: [
          ...
          Container(
            ...
            child: ListView(
              ...
              children: [
                ...
                // SizedBox(width: 15.r),
                buildRadioButtonEMP("Sanctioned Validation", "Sanctioned Validation"),
                SizedBox(width: 15.r),
                      ...
                      children: [
                        WeeklyDatePicker(
                          ...
                          changeDay: (value)async{
                            ...
                            await controller.sanctionedLeadsNetworkApi(DateFormat('yyy-MM-dd').format(value).toString(),DateFormat('yyy-MM').format(value),partnerController.loanTypeDecode(value.toString()),"","","","","", partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                          },
                        ...
                        InkWell(
                          onTap: ()async{
                            bool status = await controller.sanctionedLeadsNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","", partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                            if(status==true){
                  ...
                  children: [
                    Obx(() {
                      return ListView.builder(
                          itemCount: controller.sanctioned_leads_model.value.data.sanctionedLeade.length,
                          shrinkWrap: true,
                          physics: const NeverScrollableScrollPhysics(),
                          padding: EdgeInsets.only(bottom: 5.r),
                          itemBuilder: (context, index){
                            var data = controller.sanctioned_leads_model.value.data.sanctionedLeade[index];
                            bool isLastItem = index == controller.sanctioned_leads_model.value.data.sanctionedLeade.length - 1;
                            return CustomLeadsDetails(
                              ...
                              index: isLastItem,
                              detailsTap: ()async{
                                bool checkStatus = await controller.sanctionedLeadsNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","", partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                                if(checkStatus==true){
                                  if(controller.sanctioned_leads_model.value.data.sanctionedLeade[index].leadLockStatus=="false") {
                                    ...
                                    if(status==true) {
                                      Get.to(()=> CustomerDetails(leadId: "${data.id??""}",customerId: data.custId??"",value: "leadDetails",apiLeadId: data.leadId, pageName: "sanctionedLead",));
                                      controller.sanctionedLeadsNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","", partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                                    }
                                  }else{
                                  ...
                                  if(value == "Transfer Lead"){
                                    ...
                                    if(checkStatus==true){
                                      if(controller.sanctioned_leads_model.value.data.sanctionedLeade[index].leadLockStatus=="false") {
                                        bool status = await permissionController.lockUnlockLeadNetworkApi(controller.sanctioned_leads_model.value.data.sanctionedLeade[index].leadId, "true");
                                        if(status==true) {
                                          Get.to(()=> CustomerDetails(leadId: "${data.id??""}",customerId: data.custId??"",value: "leadDetails",apiLeadId: data.leadId, pageName: "sanctionedLead",leadTransferName: "transferLead",));
                                          controller.sanctionedLeadsNetworkApi("","",partnerController.loanTypeDecode(controller.selectLoanType.value.toString()),"","","","","", partnerController.sourceFilterSendValue(controller.filterTypeSelected.value),partnerController.leadStatusNameFilter(controller.leadsPageName.value),partnerController.leadStatusNameFilter(controller.selectEmployeePartnerValue.value));
                                        }
                                      }else{
                                        BaseController().errorSnack("Already details View on ${controller.sanctioned_leads_model.value.data.sanctionedLeade[index].lockedBy.toString()}");
                    ...
                    Obx(() => controller.sanctioned_leads_model.value.message.toString()=="Data Not Found."?
                      Container(
