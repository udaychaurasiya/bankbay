...
class LoanListDetailsKyc extends StatelessWidget {
  final AllLeade allLeade;
  const LoanListDetailsKyc({super.key, required this.allLeade});
                      ...
                      children: [
                        Padding(
                          ...
                          child: UnderLineTextField(
                            ...
                            label: true,
                            isRead: true,
                            controller: TextEditingController(text: allLeade.custPan?? ""),
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: 20.0.r),
                          child: UnderLineTextField(
                            controller: TextEditingController(text:  allLeade.custAadhar ?? "0000-0000-0000"),
