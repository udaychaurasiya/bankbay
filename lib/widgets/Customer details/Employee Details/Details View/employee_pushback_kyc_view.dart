...
class EmployeePushBackKYCViewScreen extends StatefulWidget {
  final String? empId;
  final String pageName;
  const EmployeePushBackKYCViewScreen({super.key, required this.empId, required this.pageName});

  @override
  State<EmployeePushBackKYCViewScreen> createState() => _EmployeePushBackKYCViewScreenState();
}

var partnerController =  Get.find<PartnerController>();
class _EmployeePushBackKYCViewScreenState extends State<EmployeePushBackKYCViewScreen> {
  @override
  void initState() {
                      ...
                      children: [
                        Padding(
                          ...
                          child: UnderLineTextField(
                            ...
                            label: true,
                            isRead: true,
                            controller: TextEditingController(text: partnerController.employeeDetails.value.data.basicDetails.empPan),
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: 20.0.r),
                          child: UnderLineTextField(
                            controller: TextEditingController(text: partnerController.employeeDetails.value.data.basicDetails.empAadhar),
