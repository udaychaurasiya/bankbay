...
class EmployeePushBackDocsViewScreen extends StatelessWidget {
  final EmployeeDetailsData empData;
  const EmployeePushBackDocsViewScreen({super.key, required this.empData});


  @override
  Widget build(BuildContext context) {
  var ownedValue = 1.obs;
  RxString genderValue = (empData.basicDetails.propertyOwnerType.toString()=="2"?"Family Proof":"My Proof").obs;
              ...
              child: Column(
                ...
                children: [
                  ChooseImageDocument(
                    ...
                    image: empData.basicDetails.docPassport??"",
                  ),
                  SizedBox(height: 20.r),
                  ChooseImageDocument(
                    title: "PAN Card".tr,
                    image: empData.basicDetails.docPan??"",
                  ),
                  SizedBox(height: 20.r),
                  ChooseImageDocument(
                    title: "Aadhaar (both sides)".tr,
                    image:  empData.basicDetails.docAadhar??"",
                    subTitle: "Single PDF File",
                  ),
                  SizedBox(height: 20.r),
                  ChooseImageDocument(
                    title: "Salary Slip".tr,
                    image: empData.basicDetails.docSalaryslip??"",
                  ...
                  ChooseImageDocument(
                    ...
                    image: empData.basicDetails.docBanking??"",
                  ...
                  ChooseImageDocument(
                    ...
                    image: empData.basicDetails.doc10ThProof??"",
                  ),
                  SizedBox(height: 20.r),
                  ChooseImageDocument(
                    title: "Graduation Marksheet".tr,
                    image: empData.basicDetails.docGraduationProof??"",
                    optional: true,
                  ),
                  SizedBox(height: 20.r),
                  ChooseImageDocument(
                    title: "Master/PHD Marksheet".tr,
                    image: empData.basicDetails.docMastersProof??"",
                    optional: true,
                  ),
                  SizedBox(height: 20.r),
                  ChooseImageDocument(
                    title: "Certificate Diploma".tr,
                    image: empData.basicDetails.doc12ThProof??"",
                    optional: true,
                  ),
                  SizedBox(height: 20.r),
                  ChooseImageDocument(
                    title: "Appointment & Relieving Letter From All Post Companies".tr,
                    image: empData.basicDetails.empRelivingLetter??"",
                  ),
                  SizedBox(height: 20.r),
                  ChooseImageDocument(
                    title: "Appointment Letter".tr,
                    image: empData.basicDetails.docPhdProof??"",
                      ...
                      children: [
                        ...
                        if(ownedValue.value == 1 && (genderValue.value=="My Proof"||genderValue.value=="Family Proof"))
                          ChooseImageDocument(
                            ...
                            image: empData.basicDetails.docOhp??"",
                       ...
                       if(ownedValue.value == 2 && (genderValue.value=="My Proof"||genderValue.value=="Family Proof"))
                        ...
                        if(ownedValue.value == 2 && (genderValue.value=="My Proof"||genderValue.value=="Family Proof"))
                          ChooseImageDocument(
                            ...
                            image: empData.basicDetails.docRentAgreement??"",
                        ...
                        if((ownedValue.value == 2 || ownedValue.value == 1) && genderValue.value=="Family Proof")
                          ChooseImageDocument(
                            ...
                            image:empData.basicDetails.docRelationProof??"",
                            subTitle: "subtitle",
                          ),
                      ],
                    );
