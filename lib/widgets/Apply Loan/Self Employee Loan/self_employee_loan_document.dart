...
class SelfEmployeeLoanDocument extends StatefulWidget {
  const SelfEmployeeLoanDocument({super.key});

  @override
  State<SelfEmployeeLoanDocument> createState() => _SelfEmployeeLoanDocumentState();
}

class _SelfEmployeeLoanDocumentState extends State<SelfEmployeeLoanDocument> {
  var controller = Get.find<LoginController>();
  var partnerController = Get.find<PartnerController>();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Self Employee Document"),),
          ...
          child: Obx(() => Column(
            ...
            children: [
              ...
              Center(
                child: RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: "Phone is validated. Please \nupload below documents",
              ...
              Obx(() => ChooseImageWidget(
                ...
                subTitle: controller.salarySlipsImageName.value!=""?controller.salarySlipsImageName.value: "latest 3 months",
              ...
              Center(
                child: CustomButton(
                  ...
                  width: Get.width - 200,
                  onTap: () async{
                    if (controller.panCardImage.value != "" || controller.aadhaarCardImage.value != "" ||controller.salarySlipsImage.value != "" ||controller.bankStatementImage.value != "" ||controller.ownerShipProof.value != "" ||controller.relationshipProof.value != "" ) {
                      bool status = await controller.uploadDocumentNetworkApi("", genderValue.value=="Family Proof"?2:1);
                      if(status==true){
