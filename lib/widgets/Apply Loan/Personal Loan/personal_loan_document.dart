...
class PersonalLoanDocument extends StatefulWidget {
  const PersonalLoanDocument({super.key,});

  @override
  State<PersonalLoanDocument> createState() => _PersonalLoanDocumentState();
}

class _PersonalLoanDocumentState extends State<PersonalLoanDocument> {
  var controller = Get.find<LoginController>();
  var partnerController = Get.find<PartnerController>();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Personal Document"),),
