...
class PartnerLoanFormView extends StatelessWidget {
  const PartnerLoanFormView({super.key});
          ...
          Row(
            ...
            children: [
              ...
              CustomButton(
                  ...
                  width: Get.width - 240,
                  onTap: ()async{
                    bool status = await controller.partnerLoginNetworkApi();
                    if (status == true) {
                      addPartnerTab.value=3;
                    }
                  }
              ),
            ],
