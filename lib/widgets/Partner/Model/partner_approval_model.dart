...
//
//     final partnerApprovalModel = partnerApprovalModelFromJson(jsonString);

import 'dart:convert';

PartnerApprovalModel partnerApprovalModelFromJson(String str) => PartnerApprovalModel.fromJson(json.decode(str));

String partnerApprovalModelToJson(PartnerApprovalModel data) => json.encode(data.toJson());
...
class PartnerApprovalModel {
  ...
  int? page;
  int? limit;
  List<PartnerApprovalData> data;

  PartnerApprovalModel({
    this.message,
    this.status,
    this.page,
    this.limit,
  ...
  factory PartnerApprovalModel.fromJson(Map<String, dynamic> json) => PartnerApprovalModel(
    message: json["message"],
    status: json["status"],
    page: json["page"],
    limit: json["limit"],
    data: List<PartnerApprovalData>.from(json["data"].map((x) => PartnerApprovalData.fromJson(x))),
  );
...
class PartnerApprovalData {
  ...
  factory PartnerApprovalData.fromJson(Map<String, dynamic> json) => PartnerApprovalData(
    id: json["id"],
    pid: json["pid"],
    custId: json["cust_id"],
    supId: json["sup_id"],
