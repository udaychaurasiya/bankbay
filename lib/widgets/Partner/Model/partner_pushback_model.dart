...
PartnerPushbackModel partnerPushbackModelFromJson(String str) => PartnerPushbackModel.fromJson(json.decode(str));

String partnerPushbackModelToJson(PartnerPushbackModel data) => json.encode(data.toJson());

class PartnerPushbackModel {
  String? message;
  String? status;
  int? page;
  int? limit;
  List<PartnerPushbackData> data;

  PartnerPushbackModel({
    this.message,
    this.status,
    this.page,
    this.limit,
  ...
  factory PartnerPushbackModel.fromJson(Map<String, dynamic> json) => PartnerPushbackModel(
    message: json["message"],
    status: json["status"],
    page: json["page"],
    limit: json["limit"],
    data: List<PartnerPushbackData>.from(json["data"].map((x) => PartnerPushbackData.fromJson(x))),
  );
...
class PartnerPushbackData {
  ...
  factory PartnerPushbackData.fromJson(Map<String, dynamic> json) => PartnerPushbackData(
    id: json["id"],
    pid: json["pid"],
    custId: json["cust_id"],
    supId: json["sup_id"],
