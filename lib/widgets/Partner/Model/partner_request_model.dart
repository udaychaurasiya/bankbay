...
//
//     final partnerRequestModel = partnerRequestModelFromJson(jsonString);

import 'dart:convert';

PartnerRequestModel partnerRequestModelFromJson(String str) => PartnerRequestModel.fromJson(json.decode(str));

String partnerRequestModelToJson(PartnerRequestModel data) => json.encode(data.toJson());
...
class PartnerRequestModel {
  ...
  factory PartnerRequestModel.fromJson(Map<String, dynamic> json) => PartnerRequestModel(
    ...
    page: json["page"],
    limit: json["limit"],
    data: List<PartnerRequestData>.from(json["data"].map((x) => PartnerRequestData.fromJson(x))),
  );
...
class PartnerRequestData {
  ...
  dynamic countryName;
  Access access;
  List<PartnerRemark> partnerRemarks;
  ...
  PartnerRequestData({
    ...
    required this.partnerRemarks,
  });

  factory PartnerRequestData.fromJson(Map<String, dynamic> json) => PartnerRequestData(
    id: json["id"],
    pid: json["pid"],
    custId: json["cust_id"],
    supId: json["sup_id"],
    ...
    partnerRemarks: List<PartnerRemark>.from(json["partner_remarks"].map((x) => PartnerRemark.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "partner_remarks": List<dynamic>.from(partnerRemarks.map((x) => x.toJson())),
  };
}
...
class PartnerRemark {
  ...
  factory PartnerRemark.fromJson(Map<String, dynamic> json) => PartnerRemark(
    id: json["id"],
    pid: json["pid"],
    remark: json["remark"],
