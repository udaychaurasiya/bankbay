        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("bankbay.infoggmail.com",style: fontSmall.copyWith(color: AllColors.blue.withOpacity(0.9),decoration: TextDecoration.underline)),
              SizedBox(height: 15.r),
            ],
          ),
        ),
  ...
  Widget build(BuildContext context) {
    return  Column(
      ...
      children: [
        ...
        SizedBox(height: 10.r),
        Text(value.toString(),
          style: fontSmall.copyWith(color: AllColors.black.withOpacity(0.7), fontWeight: FontWeight.w400, fontSize: 13.r),
    ...
    return  Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          SizedBox(width: 10.r),
          Expanded(child: Text(title.toString(), style: fontSmall.copyWith(color: AllColors.black.withOpacity(0.7)/*,overflow: TextOverflow.ellipsis*/),textAlign: TextAlign.left,))
        ],
      ),
    );
  }
