...
class EmployeeProfileSelfie extends StatefulWidget {
  const EmployeeProfileSelfie({super.key});

  @override
  State<EmployeeProfileSelfie> createState() => _EmployeeProfileSelfieState();
}

class _EmployeeProfileSelfieState extends State<EmployeeProfileSelfie> {
  ...
  void initState() {
    saveDataAbout();
    partnerController.employeeProfileImg.value = "";
    super.initState();
  }
  saveDataAbout()async{
    bool status = await partnerController.getEmployeeDetailsNetworkApi(GetStorage().read(AppConstant.cust_id).toString());
    if(status==true){
      profileImg.value = partnerController.employeeDetails.value.data.basicDetails.docProfilePic??"";
    }
  }
            ...
            child: InkWell(
              ...
              child: CircleAvatar(
                ...
                backgroundImage: partnerController.employeeProfileImg.value.isNotEmpty
                    ...
                    : NetworkImage(AppConstants.BASE_URL+profileImg.value.toString()),
