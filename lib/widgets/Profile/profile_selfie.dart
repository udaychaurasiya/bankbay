...
class ProfileSelfie extends StatefulWidget {
  const ProfileSelfie({super.key});

  @override
  State<ProfileSelfie> createState() => _ProfileSelfieState();
}

class _ProfileSelfieState extends State<ProfileSelfie> {
      ...
      child: Column(
        children: [
          Align(
            ...
            child: TextButton(
              onPressed: ()=> profileIndex.value=3,
              child: Text("SKIP",
              ...
              child: InkWell(
                ...
                child: CircleAvatar(
                  ...
                  backgroundImage: controller.profileImg.isNotEmpty
                      ? FileImage(File(controller.profileImg.value)) as ImageProvider<Object>
                      : NetworkImage(AppConstants.BASE_URL+GetStorage().read(AppConstant.profile).toString()),
                  child: controller.profileImg.value.isEmpty ? Icon(
