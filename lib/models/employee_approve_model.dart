...
//
//     final employeeApproveModel = employeeApproveModelFromJson(jsonString);

import 'dart:convert';

EmployeeApproveModel employeeApproveModelFromJson(String str) => EmployeeApproveModel.fromJson(json.decode(str));

String employeeApproveModelToJson(EmployeeApproveModel data) => json.encode(data.toJson());
...
class EmployeeApproveModel {
  ...
  factory EmployeeApproveModel.fromJson(Map<String, dynamic> json) => EmployeeApproveModel(
    message: json["message"],
    status: json["status"],
    data: EMPApproveData.fromJson(json["data"]),
  );
...
class EMPApproveData {
  ...
  factory EMPApproveData.fromJson(Map<String, dynamic> json) => EMPApproveData(
    limit: json["limit"],
    page: json["page"],
    empdata: List<Empdatum>.from(json["empdata"].map((x) => Empdatum.fromJson(x))),
  );
