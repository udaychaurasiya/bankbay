...
class AllEmployeeModel {
  ...
  factory AllEmployeeModel.fromJson(Map<String, dynamic> json) => AllEmployeeModel(
    ...
    status: json["status"],
    data: AllEMPData.fromJson(json["data"]),
  );
...
class AllEMPData {
  ...
  factory AllEMPData.fromJson(Map<String, dynamic> json) => AllEMPData(
    limit: json["limit"],
    page: json["page"],
    empdata: List<Empdatum2>.from(json["empdata"].map((x) => Empdatum2.fromJson(x))),
  );
...
class Empdatum2 {
  ...
  factory Empdatum2.fromJson(Map<String?, dynamic> json) => Empdatum2(
    id: json["id"],
    eid: json["eid"],
    supId: json["sup_id"],
