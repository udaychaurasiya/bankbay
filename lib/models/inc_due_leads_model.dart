...
IncDueLeadsModel incDueLeadsModelFromJson(String str) => IncDueLeadsModel.fromJson(json.decode(str));

String incDueLeadsModelToJson(IncDueLeadsModel data) => json.encode(data.toJson());

class IncDueLeadsModel {
  String? message;
  String? status;
  IncDueLeadsData data;
  ...
  factory IncDueLeadsModel.fromJson(Map<String, dynamic> json) => IncDueLeadsModel(
    message: json["message"],
    status: json["status"],
    data: IncDueLeadsData.fromJson(json["data"]),
  );
...
class IncDueLeadsData {
  ...
  factory IncDueLeadsData.fromJson(Map<String, dynamic> json) => IncDueLeadsData(
    limit: json["limit"],
    page: json["page"],
