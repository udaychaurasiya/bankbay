...
FreshLeadModel freshLeadModelFromJson(String str) => FreshLeadModel.fromJson(json.decode(str));

String freshLeadModelToJson(FreshLeadModel data) => json.encode(data.toJson());

class FreshLeadModel {
  String? message;
  String? status;
  FreshData data;
  ...
  factory FreshLeadModel.fromJson(Map<String, dynamic> json) => FreshLeadModel(
    message: json["message"],
    status: json["status"],
    data: FreshData.fromJson(json["data"]),
  );
...
class FreshData {
  int? limit;
  int? page;
  List<FreshLead> freshLead;

  FreshData({
    this.limit,
    this.page,
    required this.freshLead,
  });

  factory FreshData.fromJson(Map<String, dynamic> json) => FreshData(
    limit: json["limit"],
    page: json["page"],
    freshLead: List<FreshLead>.from(json["FreshLead"].map((x) => FreshLead.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "limit": limit,
    "page": page,
    "FreshLead": List<dynamic>.from(freshLead.map((x) => x.toJson())),
  };
}
...
class FreshLead {
  ...
  factory FreshLead.fromJson(Map<String, dynamic> json) => FreshLead(
    id: json["id"],
    leadId: json["lead_id"],
    custId: json["cust_id"],
