...
//
//     final unassignedModel = unassignedModelFromJson(jsonString);

import 'dart:convert';

UnassignedModel unassignedModelFromJson(String str) => UnassignedModel.fromJson(json.decode(str));

String unassignedModelToJson(UnassignedModel data) => json.encode(data.toJson());
...
class UnassignedModel {
  ...
  factory UnassignedModel.fromJson(Map<String, dynamic> json) => UnassignedModel(
    ...
    status: json["status"],
    data: UnassignedData.fromJson(json["data"]),
  );
...
class UnassignedData {
  int? limit;
  int? page;
  List<UnasignLeade> unasignLeade;

  UnassignedData({
    this.limit,
    this.page,
    required this.unasignLeade,
  });

  factory UnassignedData.fromJson(Map<String, dynamic> json) => UnassignedData(
    limit: json["limit"],
    page: json["page"],
    unasignLeade: List<UnasignLeade>.from(json["unasignLeade"].map((x) => UnasignLeade.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "limit": limit,
    "page": page,
    "unasignLeade": List<dynamic>.from(unasignLeade.map((x) => x.toJson())),
  };
}
...
class UnasignLeade {
  ...
  factory UnasignLeade.fromJson(Map<String, dynamic> json) => UnasignLeade(
    id: json["id"],
    leadId: json["lead_id"],
    custId: json["cust_id"],
