...
//
//     final lockUnlockLeadModel = lockUnlockLeadModelFromJson(jsonString);

import 'dart:convert';

LockUnlockLeadModel lockUnlockLeadModelFromJson(String str) => LockUnlockLeadModel.fromJson(json.decode(str));

String lockUnlockLeadModelToJson(LockUnlockLeadModel data) => json.encode(data.toJson());

class LockUnlockLeadModel {
  String? message;
  String? status;
  LockUnlockData data;
  ...
  factory LockUnlockLeadModel.fromJson(Map<String, dynamic> json) => LockUnlockLeadModel(
    message: json["message"],
    status: json["status"],
    data: LockUnlockData.fromJson(json["data"]),
  );
...
class LockUnlockData {
  ...
  factory LockUnlockData.fromJson(Map<String, dynamic> json) => LockUnlockData(
    id: json["id"],
    leadId: json["lead_id"],
    custId: json["cust_id"],
