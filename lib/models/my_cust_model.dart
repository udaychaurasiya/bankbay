...
MyCustModel myCustModelFromJson(String str) => MyCustModel.fromJson(json.decode(str));

String myCustModelToJson(MyCustModel data) => json.encode(data.toJson());
...
class MyCustModel {
  ...
  factory MyCustModel.fromJson(Map<String, dynamic> json) => MyCustModel(
    message: json["message"],
    status: json["status"],
    page: json["page"],
    limit: json["limit"],
    data: json["data"]==null?[]:List<MyCustData>.from(json["data"].map((x) => MyCustData.fromJson(x))),
  );
...
class MyCustData {
  ...
  factory MyCustData.fromJson(Map<String, dynamic> json) => MyCustData(
    id: json["id"],
    custId: json["cust_id"],
