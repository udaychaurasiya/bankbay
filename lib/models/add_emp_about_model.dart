...
//
//     final addEmpAboutModel = addEmpAboutModelFromJson(jsonString);

import 'dart:convert';

AddEmpAboutModel addEmpAboutModelFromJson(String str) => AddEmpAboutModel.fromJson(json.decode(str));

String addEmpAboutModelToJson(AddEmpAboutModel data) => json.encode(data.toJson());

class AddEmpAboutModel {
  String? message;
  String? status;
  AboutData data;
  ...
  factory AddEmpAboutModel.fromJson(Map<String, dynamic> json) => AddEmpAboutModel(
...
class AboutData {
  ...
  factory AboutData.fromJson(Map<String, dynamic> json) => AboutData(
    ...
    allLead: json["allLead"]==null?[]:List<AllLead>.from(json["allLead"].map((x) => AllLead.fromJson(x))),
  );
