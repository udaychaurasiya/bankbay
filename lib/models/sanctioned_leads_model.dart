...
SanctionedLeadsModel sanctionedLeadsModelFromJson(String str) => SanctionedLeadsModel.fromJson(json.decode(str));

String sanctionedLeadsModelToJson(SanctionedLeadsModel data) => json.encode(data.toJson());

class SanctionedLeadsModel {
  String? message;
  String? status;
  SanctionedLeadsData data;

  SanctionedLeadsModel({
    this.message,
    this.status,
    required this.data,
  });

  factory SanctionedLeadsModel.fromJson(Map<String, dynamic> json) => SanctionedLeadsModel(
    message: json["message"],
    status: json["status"],
    data: SanctionedLeadsData.fromJson(json["data"]),
  );
...
class SanctionedLeadsData {
  int? limit;
  int? page;
  List<SanctionedLeade> sanctionedLeade;

  SanctionedLeadsData({
    this.limit,
    this.page,
    required this.sanctionedLeade,
  });

  factory SanctionedLeadsData.fromJson(Map<String, dynamic> json) => SanctionedLeadsData(
    limit: json["limit"],
    page: json["page"],
    sanctionedLeade: json["sanctionedLeade"]==null?[]:List<SanctionedLeade>.from(json["sanctionedLeade"].map((x) => SanctionedLeade.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "limit": limit,
    "page": page,
    "sanctionedLeade": List<dynamic>.from(sanctionedLeade.map((x) => x.toJson())),
  };
}

class SanctionedLeade {
  int? id;
  String? leadId;
  String? custId;
  String? custName;
  ...
  factory SanctionedLeade.fromJson(Map<String, dynamic> json) => SanctionedLeade(
    id: json["id"],
    leadId: json["lead_id"],
    custId: json["cust_id"],
