...
VerificationDataModel verificationDataModelFromJson(String str) => VerificationDataModel.fromJson(json.decode(str));

String verificationDataModelToJson(VerificationDataModel data) => json.encode(data.toJson());

class VerificationDataModel {
  String? message;
  String? status;
  VerificationDataList data;
  ...
  factory VerificationDataModel.fromJson(Map<String, dynamic> json) => VerificationDataModel(
    ...
    status: json["status"],
    data: VerificationDataList.fromJson(json["data"]),
  );
...
class VerificationDataList {
  ...
  factory VerificationDataList.fromJson(Map<String, dynamic> json) => VerificationDataList(
    limit: json["limit"],
    page: json["page"],
