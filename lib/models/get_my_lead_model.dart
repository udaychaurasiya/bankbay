...
//
//     final getMyLeadModel = getMyLeadModelFromJson(jsonString);

import 'dart:convert';

GetMyLeadModel getMyLeadModelFromJson(String str) => GetMyLeadModel.fromJson(json.decode(str));

String getMyLeadModelToJson(GetMyLeadModel data) => json.encode(data.toJson());

class GetMyLeadModel {
  String? message;
  String? status;
  MyLeadData data;
  ...
  factory GetMyLeadModel.fromJson(Map<String, dynamic> json) => GetMyLeadModel(
    message: json["message"],
    status: json["status"],
    data: MyLeadData.fromJson(json["data"]),
  );
...
class MyLeadData {
  ...
  int? page;
  List<Count> counts;
  List<AllLead> allLead;

  MyLeadData({
    this.limit,
    this.page,
    required this.counts,
    required this.allLead,
  });

  factory MyLeadData.fromJson(Map<String, dynamic> json) => MyLeadData(
    limit: json["limit"],
    page: json["page"],
    counts: json["counts"]==null?[]:List<Count>.from(json["counts"].map((x) => Count.fromJson(x))),
    allLead: List<AllLead>.from(json["allLead"].map((x) => AllLead.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "allLead": List<dynamic>.from(allLead.map((x) => x.toJson())),
  };
}
...
class AllLead {
  ...
  factory AllLead.fromJson(Map<String, dynamic> json) => AllLead(
    id: json["id"],
    leadId: json["lead_id"],
    custId: json["cust_id"],
