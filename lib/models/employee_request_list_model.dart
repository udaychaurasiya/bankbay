...
EmployeeRequestList employeeRequestListFromJson(String str) => EmployeeRequestList.fromJson(json.decode(str));

String employeeRequestListToJson(EmployeeRequestList data) => json.encode(data.toJson());

class EmployeeRequestList {
  String? message;
  String? status;
  ...
  factory EmployeeRequestList.fromJson(Map<String, dynamic> json) => EmployeeRequestList(
    message: json["message"],
    status: json["status"],
    data: EmployeeRequestData.fromJson(json["data"]),
  );
...
class EmployeeRequestData {
  ...
  factory EmployeeRequestData.fromJson(Map<String, dynamic> json) => EmployeeRequestData(
    limit: json["limit"],
    page: json["page"],
    empdata: List<EmpRequestData>.from(json["empdata"].map((x) => EmpRequestData.fromJson(x))),
  );
...
class EmpRequestData {
  ...
  factory EmpRequestData.fromJson(Map<String, dynamic> json) => EmpRequestData(
    id: json["id"],
    eid: json["eid"],
    supId: json["sup_id"],
...
class AccessSpecial {
  ...
  dynamic accessChangeBy;
  DateTime? accessChangeDateTime;
  String? isStatus;
  String? empViewAll;
  String? addEmp;
  String? updateEmp;
  ...
  factory AccessSpecial.fromJson(Map<String, dynamic> json) => AccessSpecial(
    ...
    accessChangeDateTime: DateTime.parse(json["access_change_date_time"]??"00000000"),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "access_change_date_time": accessChangeDateTime!.toIso8601String(),
    "is_status": isStatus,
    "emp_view_all": empViewAll,
    "add_emp": addEmp,
    "update_emp": updateEmp,
