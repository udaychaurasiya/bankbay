...
HoldLeadsModel holdLeadsModelFromJson(String str) => HoldLeadsModel.fromJson(json.decode(str));

String holdLeadsModelToJson(HoldLeadsModel data) => json.encode(data.toJson());

class HoldLeadsModel {
  String? message;
  String? status;
  HoldLeadsData data;
  ...
  factory HoldLeadsModel.fromJson(Map<String, dynamic> json) => HoldLeadsModel(
    message: json["message"],
    status: json["status"],
    data: HoldLeadsData.fromJson(json["data"]),
  );
...
class HoldLeadsData {
  int? limit;
  int? page;
  List<HoldLeade> holdLeade;

  HoldLeadsData({
    this.limit,
    this.page,
    required this.holdLeade,
  });

  factory HoldLeadsData.fromJson(Map<String, dynamic> json) => HoldLeadsData(
    limit: json["limit"],
    page: json["page"],
    holdLeade: List<HoldLeade>.from(json["holdLeade"].map((x) => HoldLeade.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "limit": limit,
    "page": page,
    "holdLeade": List<dynamic>.from(holdLeade.map((x) => x.toJson())),
  };
}
...
class HoldLeade {
  ...
  factory HoldLeade.fromJson(Map<String, dynamic> json) => HoldLeade(
    id: json["id"],
    leadId: json["lead_id"],
    custId: json["cust_id"],
