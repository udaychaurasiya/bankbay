...
IncPaidLeadsModel incPaidLeadsModelFromJson(String str) => IncPaidLeadsModel.fromJson(json.decode(str));

String incPaidLeadsModelToJson(IncPaidLeadsModel data) => json.encode(data.toJson());

class IncPaidLeadsModel {
  String? message;
  String? status;
  IncPaidLeadsData data;
  ...
  factory IncPaidLeadsModel.fromJson(Map<String, dynamic> json) => IncPaidLeadsModel(
    message: json["message"],
    status: json["status"],
    data: IncPaidLeadsData.fromJson(json["data"]),
  );
...
class IncPaidLeadsData {
  int? limit;
  int? page;
  List<DisbursedLeade> disbursedLeade;

  IncPaidLeadsData({
    this.limit,
    this.page,
    required this.disbursedLeade,
  });

  factory IncPaidLeadsData.fromJson(Map<String, dynamic> json) => IncPaidLeadsData(
    limit: json["limit"],
    page: json["page"],
    disbursedLeade: json["disbursedLeade"]==null?[]:List<DisbursedLeade>.from(json["disbursedLeade"].map((x) => DisbursedLeade.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "limit": limit,
    "page": page,
    "disbursedLeade": List<dynamic>.from(disbursedLeade.map((x) => x.toJson())),
  };
}

class DisbursedLeade {
  int? id;
  String? leadId;
  String? custId;
  String? custName;
  ...
  factory DisbursedLeade.fromJson(Map<String, dynamic> json) => DisbursedLeade(
    id: json["id"],
    leadId: json["lead_id"],
    custId: json["cust_id"],
