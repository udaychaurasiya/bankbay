...
VerifiedLeadsModel verifiedLeadsModelFromJson(String str) => VerifiedLeadsModel.fromJson(json.decode(str));

String verifiedLeadsModelToJson(VerifiedLeadsModel data) => json.encode(data.toJson());

class VerifiedLeadsModel {
  String? message;
  String? status;
  VerifiedLeadsData data;
  ...
  factory VerifiedLeadsModel.fromJson(Map<String, dynamic> json) => VerifiedLeadsModel(
    message: json["message"],
    status: json["status"],
    data: VerifiedLeadsData.fromJson(json["data"]),
  );
...
class VerifiedLeadsData {
  int? limit;
  int? page;
  List<VerifiedLeade> verifiedLeade;

  VerifiedLeadsData({
    this.limit,
    this.page,
    required this.verifiedLeade,
  });

  factory VerifiedLeadsData.fromJson(Map<String, dynamic> json) => VerifiedLeadsData(
    limit: json["limit"],
    page: json["page"],
    verifiedLeade: json["verifiedLeade"]==null?[]:List<VerifiedLeade>.from(json["verifiedLeade"].map((x) => VerifiedLeade.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "limit": limit,
    "page": page,
    "verifiedLeade": List<dynamic>.from(verifiedLeade.map((x) => x.toJson())),
  };
}
...
class VerifiedLeade {
  ...
  factory VerifiedLeade.fromJson(Map<String, dynamic> json) => VerifiedLeade(
    id: json["id"],
    leadId: json["lead_id"],
    custId: json["cust_id"],
