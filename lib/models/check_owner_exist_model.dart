...
CheckOwnerExistModel checkOwnerExistModelFromJson(String str) => CheckOwnerExistModel.fromJson(json.decode(str));

String checkOwnerExistModelToJson(CheckOwnerExistModel data) => json.encode(data.toJson());

class CheckOwnerExistModel {
  String? message;
  String? status;
  List<Datum> data;

  CheckOwnerExistModel({
    this.message,
    this.status,
    required this.data,
  });

  factory CheckOwnerExistModel.fromJson(Map<String, dynamic> json) => CheckOwnerExistModel(
