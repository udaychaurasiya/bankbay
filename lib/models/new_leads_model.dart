...
NewLeadsModel newLeadsModelFromJson(String str) => NewLeadsModel.fromJson(json.decode(str));

String newLeadsModelToJson(NewLeadsModel data) => json.encode(data.toJson());
...
class NewLeadsModel {
  ...
  factory NewLeadsModel.fromJson(Map<String, dynamic> json) => NewLeadsModel(
    message: json["message"],
    status: json["status"],
    data: NewLeadsData.fromJson(json["data"]),
  );
...
class NewLeadsData {
  ...
  factory NewLeadsData.fromJson(Map<String, dynamic> json) => NewLeadsData(
    limit: json["limit"],
    page: json["page"],
