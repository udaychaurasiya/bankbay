...
AllLeadDataModel allLeadDataModelFromJson(String str) => AllLeadDataModel.fromJson(json.decode(str));

String allLeadDataModelToJson(AllLeadDataModel data) => json.encode(data.toJson());

class AllLeadDataModel {
  String? message;
  String? status;
  AllDataList data;
  ...
  factory AllLeadDataModel.fromJson(Map<String, dynamic> json) => AllLeadDataModel(
    message: json["message"],
    status: json["status"],
    data: AllDataList.fromJson(json["data"]),
  );
...
class AllDataList {
  int? limit;
  int? page;
  List<NewLeade> newLeade;

  AllDataList({
    this.limit,
    this.page,
    required this.newLeade,
  });

  factory AllDataList.fromJson(Map<String, dynamic> json) => AllDataList(
    limit: json["limit"],
    page: json["page"],
    newLeade: List<NewLeade>.from(json["newLeade"].map((x) => NewLeade.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "limit": limit,
    "page": page,
    "newLeade": List<dynamic>.from(newLeade.map((x) => x.toJson())),
  };
}
...
class NewLeade {
  ...
  factory NewLeade.fromJson(Map<String, dynamic> json) => NewLeade(
    id: json["id"],
    leadId: json["lead_id"],
    custId: json["cust_id"],
    ...
    // custActiveLoan:json["cust_active_loan"]==null?[]:List<CustActiveLoan>.from(json["cust_active_loan"].map((x) => CustActiveLoan.fromJson(x))),
