...
IncApprovalModel incApprovalModelFromJson(String str) => IncApprovalModel.fromJson(json.decode(str));

String incApprovalModelToJson(IncApprovalModel data) => json.encode(data.toJson());

class IncApprovalModel {
  String? message;
  String? status;
  IncApprovalData data;
  ...
  factory IncApprovalModel.fromJson(Map<String, dynamic> json) => IncApprovalModel(
    message: json["message"],
    status: json["status"],
    data: IncApprovalData.fromJson(json["data"]),
  );
...
class IncApprovalData {
  ...
  factory IncApprovalData.fromJson(Map<String, dynamic> json) => IncApprovalData(
    limit: json["limit"],
    page: json["page"],
    loginLeade: json["loginLeade"]==null?[]:List<LoginLeade>.from(json["loginLeade"].map((x) => LoginLeade.fromJson(x))),
  );
...
class History {
  ...
  factory History.fromJson(Map<String, dynamic> json) => History(
    ...
    incAttachment: List<dynamic>.from(json["inc_attachment"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "inc_attachment": List<dynamic>.from(incAttachment.map((x) => x)),
