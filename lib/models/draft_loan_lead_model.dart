...
DraftLoanLeadModel draftLoanLeadModelFromJson(String str) => DraftLoanLeadModel.fromJson(json.decode(str));

String draftLoanLeadModelToJson(DraftLoanLeadModel data) => json.encode(data.toJson());

class DraftLoanLeadModel {
  String? message;
  String? status;
  DraftLoanLeadData data;
  ...
  factory DraftLoanLeadModel.fromJson(Map<String, dynamic> json) => DraftLoanLeadModel(
    message: json["message"],
    status: json["status"],
    data: DraftLoanLeadData.fromJson(json["data"]),
  );
...
class DraftLoanLeadData {
  ...
  factory DraftLoanLeadData.fromJson(Map<String, dynamic> json) => DraftLoanLeadData(
    limit: json["limit"],
    page: json["page"],
