...
MyLoanHistoryModel myLoanHistoryModelFromJson(String str) => MyLoanHistoryModel.fromJson(json.decode(str));

String myLoanHistoryModelToJson(MyLoanHistoryModel data) => json.encode(data.toJson());

class MyLoanHistoryModel {
  String? message;
  String? status;
  MyLoanHistoryData data;
  ...
  factory MyLoanHistoryModel.fromJson(Map<String, dynamic> json) => MyLoanHistoryModel(
    message: json["message"],
    status: json["status"],
    data: MyLoanHistoryData.fromJson(json["data"]),
  );
...
class MyLoanHistoryData {
  ...
  factory MyLoanHistoryData.fromJson(Map<String, dynamic> json) => MyLoanHistoryData(
    limit: json["limit"],
    page: json["page"],
