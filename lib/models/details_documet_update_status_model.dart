...
DetailsUpdateDocumentStatusModel detailsUpdateDocumentStatusModelFromJson(String str) => DetailsUpdateDocumentStatusModel.fromJson(json.decode(str));

String detailsUpdateDocumentStatusModelToJson(DetailsUpdateDocumentStatusModel data) => json.encode(data.toJson());

class DetailsUpdateDocumentStatusModel {
  String? message;
  String? status;
  List<Datum> data;

  DetailsUpdateDocumentStatusModel({
    this.message,
    this.status,
    required this.data,
  });

  factory DetailsUpdateDocumentStatusModel.fromJson(Map<String, dynamic> json) => DetailsUpdateDocumentStatusModel(
